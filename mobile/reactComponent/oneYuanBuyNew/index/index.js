    ...
    return (
      <div>
        <div className={cNs(mmhc.backDiv,this.state.versionTitel==1?mmhc.title12:"")}>
          <a className={mmhc.backCss} href="back">
            <img src={this.state.versionTitel==1?back2Img:backIcon} width="12px" alt=""/>
          </a>
          {this.state.activityIdState==9?"宝粉专区":"精选硬货"}
          <a className={mmhc.shareBaobao} href={"sharebaobao,"+eshopHomePath+"/oneYuanBuyNewSharePro.html?activityId="+this.state.activityIdState+",蜜麻花兑换专区,蜜麻花兑换专区"}>
                  ...
                  this.state.historyList.map(function(normalListM,index){
                    return normalListM.buyingHistoryAssistVO.status!=1?<div key={index} className={cNs("swiper-slide")}>
                              <div key={index} className={mmhc.recommendMHistory}>
                                <a href={"/seckillpay/new-"+normalListM.activityProductVO.product.id+".html?acId="+normalListM.activityProductVO.id+"&bhId="+normalListM.buyingHistoryAssistVO.id+"&prdCode="+normalListM.activityProductVO.product.id+"&postageFree="+normalListM.activityProductVO.isPostageFree+"&activityId="+this.state.activityIdState}>
                                ...
                                <div className={mmhc.recommendMShare}>
                                  <a className={mmhc.recommendMShareA} href={"/seckillpay/new-"+normalListM.activityProductVO.product.id+".html?acId="+normalListM.activityProductVO.id+"&bhId="+normalListM.buyingHistoryAssistVO.id+"&prdCode="+normalListM.activityProductVO.product.id+"&postageFree="+normalListM.activityProductVO.isPostageFree+"&activityId="+this.state.activityIdState}>
                                    {
        ...
        <div className={mmhc.recommendContainer}>
          {
            this.state.normalList.map(function(normalListM,index){
              return <div key={index} className={mmhc.recommendM}>
                      ...
                      <div className={mmhc.recommendMShare}>
                        <a className={mmhc.recommendMShareA} href={"/seckillpay/new-"+normalListM.activityProductVO.product.id+".html?acId="+normalListM.activityProductVO.id+"&bhId="+normalListM.buyingHistoryAssistVO.id+"&prdCode="+normalListM.activityProductVO.product.id+"&postageFree="+normalListM.activityProductVO.isPostageFree+"&activityId="+this.state.activityIdState}>查看详情</a>
                      </div>
                    </div>
            }.bind(this))
          }

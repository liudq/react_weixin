    ...
    return (
      <div className={cNs(this.props.commodity2,mmhc.background)}>
          ...
          <div className={cNs(mmhc.spe,this.props.guiGeState)}>
            ...
            <div onClick={this.onClickShopping3} className={mmhc.speSce4Shopping}>立即支付</div>
      ...
      <div>
        <div className={mmhc.titleAll}>
          <div className={mmhc.title}>
            {this.state.apkState==1?<a href="back" className={mmhc.titleLeft}><img className={mmhc.backImg} src={backImg} alt=""/></a>:<a href="/bargain.html" className={mmhc.titleLeft}><img className={mmhc.backImg} src={backImg} alt=""/></a>}
        ...
        <div className={mmhc.content5}>
          ...
          <div className={mmhc.bargainBottom}>
            <div className={mmhc.bargainLeft}>最低价:￥{this.state.minPrice}</div>
            <div className={mmhc.bargainRight}>
              <div onClick={this.onClickShopping} className={mmhc.bargainRight1}>立即支付</div>
              <div onClick={this.toShare} className={mmhc.bargainRight2}>去砍价</div>
              <div className={mmhc.clear}></div>
            </div>
            <div className={mmhc.clear}></div>
          </div>

...
var mmhc = require("./activityChildFive.css");
    ...
    return (
      <div className={mmhc.content}>
          <div className={cNs(mmhc.title,this.state.versionTitel==1?mmhc.titel12:"")}>
            ...
            爆款专场 2折起
            <a className={mmhc.shareBaobao} href={"sharebaobao,"+eshopHomePath+"/activity/activityChildFiveShare.html,爆款专场全品类两折起,诚意满满 实惠多多!"}>
          ...
          <div className={mmhc.bannerContainer}>
            ...
            <div className={cNs(mmhc.rule,this.state.ruleShowFlag==true?mmhc.show:"")}>
              <h1>活动规则</h1>
              <p>1、不限购买数量，不限购买次数；</p>
              <p>2、6.1爆款专场2折起起活动专场享79元包邮；</p>
              <p>3、活动时间：5月25日-6月3日。</p>

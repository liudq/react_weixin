      ...
      <div className={mmhc.content}>
        ...
        <div className={mmhc.registContent}>
          ...
          <div className={mmhc.registSection}>
            ...
            {this.state.text==1?"恭喜您扫码成功！":"恭喜您注册成功！"}
        ...
        <a style={{"display":"none"}} className={mmhc.onlineCss} href={"/weixinSigningFee/authc/offlinePayment.html?userCode="+this.state.userCode}>线下店购物缴费入口</a>
      </div>
    )
  },

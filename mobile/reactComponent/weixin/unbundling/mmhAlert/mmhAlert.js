...
var Main = React.createClass({
      ...
      <div>
        ...
        <div id={mmhc.alert_div} className={this.state.divShow===true?mmhc.show:""}>
          ...
          <div id={mmhc.footer}>
            ...
            <a href="" id={mmhc.no} onClick={this.close1} className={this.state.noShow===true?mmhc.show:""}>取消</a>
          </div>
        </div>
      </div>
    )
  ...
  componentDidMount: function() {
    ...
    window.confirm = function(mess, callback, callback1) {
      this.setState({
        content: mess,
        maskShow: true,
        divShow: true,

    ...
    return (
      <div>
        <div className={mmhc.registerTitle}>
          {this.state.fromHome==1?<a href="back" className={mmhc.backImgI}><img src={backImg} alt=""/></a>:""}
          快速注册
        </div>
        ...
        <div className={cNs(mmhc.register,this.state.zhuCe)}>
          ...
          <div onClick={this.noEmpty} className={mmhc.button}>注&nbsp;&nbsp;&nbsp;&nbsp;册</div>
          <div className={mmhc.registerBottom}>

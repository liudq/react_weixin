...
class Main extends React.Component {
  ...
  showList2() {
    ...
    // spread(event) {
    //   var tradeName = $(event.target).attr("data-id");
      ...
      <div>
              ...
              <div className={cNs(mmhc.infContent,mmhc.clearfix)}>
                ...
                <div className={cNs(mmhc.spreadList,this.state.listFlag1==true?mmhc.show:"")}>
                  <div className={cNs(mmhc.listCon,mmhc.clearfix)} data-id="fenxiao" >
                  ...
                  <div className={cNs(mmhc.listCon,mmhc.clearfix)} data-id="jingxiao">
                  ...
                  <div className={cNs(mmhc.listCon,mmhc.clearfix)} data-id="daili">
  ...
  componentDidMount() {
    ...
    $.ajax({
      ...
      // /myExtensionFenX.json

      url: jsonPath.path + '/myExtensionFenX.json?userCode=' + userCode + '&sign=' + sign,

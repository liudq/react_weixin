      ...
      success: function(dataJson) {
        if (dataJson.success) {
          if (dataJson.data.goJumpPayfor == false) {
            ...
            window.location.href = "/order/payAndProductNew.html?relationOrderSn=" + dataJson.data.relationOrderSn + "&paySessionstr=" + dataJson.data.paySessionstr + "&rid" + Math.random() + "&paymentName=" + this.state.payName + "&paymentCode=" + this.state.payCode;
          }
        } else {
            ...
            success: function(dataJson) {
              if (dataJson.success) {
                if (dataJson.data.goJumpPayfor == false) {
                  ...
                  window.location.href = "/order/payAndProductNew.html?relationOrderSn=" + dataJson.data.relationOrderSn + "&paySessionstr=" + dataJson.data.paySessionstr + "&rid" + Math.random();
                }
              } else {
                alert(dataJson.message);
              }

...
var mmhc = require("./activityBargainclShare.css");
...
var ActivityChildOne = React.createClass({
    ...
    return (
      <div className={mmhc.content}>
          ...
          <div className={cNs(mmhc.specialTitle,this.state.versionTitel==1?mmhc.titel12:"")}>
            ...
            活动专场
            <a className={mmhc.shareBaobao} href={"sharebaobao,"+eshopHomePath+"/fourChooseOneShare.html,呼朋唤友来砍价,分享至微信朋友圈其他人打开分享页面并点击砍价!"}>
  ...
  componentDidMount: function() {
    ...
    $.ajax({
      ...
      url: jsonPath.path + "/buyhistorylist.json?activityId=" + 25,
      type: jsonPath.method,
      error:function(){
        // alert(123)
      },

...
var casPath = require("../../common/util/path.js").casPath;
...
var SingleCommodity = React.createClass({
  ...
  onClickShopping: function() {
    this.setState({
      casUrl: casPath + "/login?service=" + window.location.href
    });
    $("body").trigger("click");
    this.setState({
  ...
  render: function() {
    return (
      <div>
        <div className={mmhc.titleAll}>
          ...
          <div onClick={this.titleMore} className={cNs(mmhc.title2,this.state.titleMore)}>
            <div className={mmhc.title2Content}>
              ...
              <a href="/shoppingCar.html" className={mmhc.title2Con4}>
        ...
        <div className={mmhc.content5}>
          <div className={mmhc.con5Left}>
            ...
            <a href="/authc/shoppingCar.html" className={mmhc.bottom3}>
      ...
      {/*弹出规格*/}
        ...
        <iframe style={{"display":"none"}} src={this.state.casUrl} frameborder="0"></iframe>
      </div>
    )
  },

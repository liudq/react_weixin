...
var mmhc = require("./activityDuanWuOnecl.css");
    ...
    return (
      <div className={mmhc.content}>
          ...
          <div className={cNs(mmhc.specialTitle,this.state.versionTitel==1?mmhc.titel12:"")}>
            ...
            一分钱专场活动
            <a className={mmhc.shareBaobao} href={"sharebaobao,"+eshopHomePath+"/fourChooseOneShare.html,1分钱四选一活动,订单满79元包邮！可使用10元优惠券!"}>
                        ...
                        <ul className={mmhc.clearfix}>
                          {
                            this.state.activityProductVOList.map(function(elem,index){
                              return index<4?<li key={index} className={cNs(mmhc.fl,mmhc.productM)}>
                                        <a href={"/detail.html?prdCode="+elem.id+"&activityId="+this.state.activityId}>
                                        ...
                                        <div className={cNs(mmhc.moneyCart,mmhc.clearfix)}>
                                          ...
                                          <div className={mmhc.fl}>
                                            <em className={mmhc.moneyN3}></em>
                                            {
                                              // <em className={mmhc.moneyN3}>￥:{elem.marketPrice}</em>
                                            }
                                          </div>
                                          <div className={cNs(mmhc.fr,mmhc.cartAA)}>
                                            <img onClick={this.fnAddCar} data-id={elem.id} src={cartA} alt=""/>
          ...
          <div className={mmhc.wrapper}>123
            <div className={mmhc.scroller}>
              <div className={mmhc.pullDown}>
                <span className={mmhc.pullDownIcon}></span><span className={mmhc.pullDownLabel}>Pull down to refresh...</span>
              </div>

              <ul className={mmhc.thelist}>
                <li>上划显示更多</li>
              </ul>
              <div className={mmhc.pullUp}>
                <span className={mmhc.pullUpIcon}></span><span className={mmhc.pullUpLabel}>Pull up to refresh...</span>
              </div>
            </div>
          </div>
...
//   pullDownOffset = $("."+mmhc.pullDown).offsetHeight;
//   pullUpEl = document.getElementById('pullUp');
//   pullUpOffset = $("."+mmhc.pullUpEl).offsetHeight;

//   myScroll = new iScroll('wrapper', {
//     useTransition: true,
//     topOffset: pullDownOffset,
//     onRefresh: function () {
//       if ($("."+mmhc.pullDown).className.match('loading')) {
//         $("."+mmhc.pullDown).className = '';
//         $("."+mmhc.pullDown).querySelector("."+mmhc.pullDownLabel).innerHTML = 'Pull down to refresh...';
//       } else if (pullUpEl.className.match('loading')) {
//         $("."+mmhc.pullUp).className = '';
//         $("."+mmhc.pullUp).querySelector("."+mmhc.pullUpLabel).innerHTML = 'Pull up to load more...';
//       }
//     },
//     onScrollMove: function () {
//       window.location.href="./fourChooseOneBaoKuan.html";

//       if (this.y > 5 && !$("."+mmhc.pullDown).className.match('flip')) {
//         $("."+mmhc.pullDown).className = mmhc.flip;
//         $("."+mmhc.pullDown).querySelector("."+mmhc.pullDownLabel).innerHTML = 'Release to refresh...';
//         this.minScrollY = 0;
//       } else if (this.y < 5 && $("."+mmhc.pullDown).className.match('flip')) {
//         $("."+mmhc.pullDown).className = '';
//         $("."+mmhc.pullDown).querySelector("."+mmhc.pullDownLabel).innerHTML = 'Pull down to refresh...';
//         this.minScrollY = -pullDownOffset;
//       } else if (this.y < (this.maxScrollY - 5) && !$("."+mmhc.pullUp).className.match('flip')) {
//         $("."+mmhc.pullUp).className = 'flip';
//         $("."+mmhc.pullUp).querySelector($("."+mmhc.pullUpLabel)).innerHTML = 'Release to refresh...';
...
//       if ($("."+mmhc.pullDown).className.match('flip')) {
//         $("."+mmhc.pullDown).className = mmhc.loading;
//         // pullDownEl.querySelector('.pullDownLabel').innerHTML = 'Loading...';
//         pullDownAction(); // Execute custom function (ajax call?)
//       } else if ($("."+mmhc.pullUp).className.match('flip')) {
//         $("."+mmhc.pullUp).className = mmhc.loading;
...
//   setTimeout(function () { $("."+mmhc.wrapper).style.left = '0'; }, 800);
// }
